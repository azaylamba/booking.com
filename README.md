...
You have to design & build the backend for the application and the ability for the users to register, add and search the properties.
...
https://github.com/azaylamba/booking.com 
